...
<div class="postbox">
    <div class="postbox-header">
        <h2 class="hndle">🔗 Mapping Penulis ke Persona</h2>
    </div>
    <div class="inside">
            ...
            <table class="wp-list-table widefat fixed striped" style="margin-bottom: 15px;">
                ...
                <tbody>
                    <?php if ( ! empty( $authors ) ) : ?>
                        ...
                        <?php endforeach; ?>
                    <?php else : ?>
                        <tr><td colspan="3" style="color:#646970; font-style:italic;">No authors found.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
...
<div class="postbox">
    <div class="postbox-header">
        <h2 class="hndle">🎭 Manajemen Persona Master</h2>
    </div>
    <div class="inside">
        ...
        <h3 style="font-size:14px; font-weight:600; margin-bottom:12px;">➕ Tambah Persona Baru</h3>
        <form method="post">
            <?php wp_nonce_field( 'autoblog_add_persona_nonce' ); ?>
            <div style="margin-bottom:10px;">
                <input type="text" name="persona_name" placeholder="Nama Persona (cth: Si Tekno)" style="width:100%; max-width:400px;" required>
            </div>
            <div style="margin-bottom:12px;">
                <textarea name="persona_desc" rows="3" placeholder="Deskripsi/Prompt Persona (cth: Kamu adalah seorang kutu buku yang sangat teliti...)" style="width:100%; max-width:600px;" required></textarea>
            </div>
