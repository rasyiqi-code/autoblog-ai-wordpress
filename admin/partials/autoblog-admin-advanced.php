<form method="post" action="options.php">
    ...
    <div class="postbox">
        <div class="postbox-header">
            <h2 class="hndle">Advanced Agentic Features</h2>
        </div>
        <div class="inside">
            <p class="description">Enable these features to transform Autoblog into a fully autonomous research and writing agent. Note that some features will increase API usage.</p>
